        ...
        <div className="flex flex-col gap-4 border-b border-border p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              {unreadCount > 0 && (
                <span className="rounded-full bg-primary px-2 py-0.5 text-xxs font-bold text-white">
                  {unreadCount}
                </span>
              )}
            </div>
            ...
            displayNotifications.map((notif) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0 space-y-1">
                  ...
                  <p className="text-xxs text-muted-foreground leading-relaxed">{notif.message}</p>
                </div>
              </div>
            ))
          )}
